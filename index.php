        ...
        <div class="">
            <div class="dark ">
                <div class="flex space_bwtn">
                    ...
                    <div class="flex">
                        <p class="DoHyeo">Published On </p>: <div class="Architects"><?php echo $post['post_date'];?></div>
                    </div>
                </div>
            ...
            <div class=" <?php echo $class_post;?>">
                <h1 class="liht_dark Montserrat">
                    <a href="?p=<?php echo $post['ID'];?>" style="font-size: medium;font-weight: 700;letter-spacing: 1.3px;">
                        <?php echo $post['post_title']; ?>
                    </a>
                </h1>
                <p class="padding"> <?php echo nl2br($post['post_content']) ; ?> </p>
            </div>
        </div>
