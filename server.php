...
//register process.............
    if(isset($_POST['register'])){
        ...
        if(count($errors) == 0){
            ...
            $_SESSION['success']= $username.", your registration complete. Now, login.";
...
if(isset($_POST['postNew_submit'])){
    ...
    if(count($errors) == 0){
        $sql = "INSERT INTO `posts` (post_title, post_content, post_date, post_username) 
